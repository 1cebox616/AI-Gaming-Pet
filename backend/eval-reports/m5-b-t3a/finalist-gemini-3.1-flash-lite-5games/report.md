# M5-B-T3a Google Gemini 3.1 Flash Lite finalist 游戏知识探针报告

本轮只验证修改后的详细游戏 context 提示词，不替换上一轮正式 3 模型 × 15 游戏判卷，也不作选型推荐。

## 模型与样本

- 模型：[Google Gemini 3.1 Flash Lite finalist](https://openrouter.ai/google/gemini-3.1-flash-lite)（`google/gemini-3.1-flash-lite`）。
...
|---|---:|---:|---:|---:|---:|---:|
| 联网模式 | 5/5 | 4/5 | 4/5 | 4.056 / 4.488 / 4.686 | 5/5 | $0.008240000 |

## 逐次结果

| 游戏 | 模式 | 状态 | 实际模型／上游 | 耗时（秒） | 输入／输出／推理 token | finish_reason | 花费（USD） |
|---|---|---|---|---:|---:|---|---:|
| Overwatch 2 | online | 格式不合 | google/gemini-3.1-flash-lite / OpenAI | 4.686 | 1295/882/0 | stop | $0.001646750 |
| Tom Clancy&#x27;s Rainbow Six Siege | online | 成功 | google/gemini-3.1-flash-lite / OpenAI | 4.056 | 1298/873/0 | stop | $0.001634000 |
| Genshin Impact | online | 成功 | google/gemini-3.1-flash-lite / OpenAI | 4.191 | 1295/922/0 | stop | $0.001706750 |
| Kingdom Come: Deliverance II | online | 成功 | google/gemini-3.1-flash-lite / OpenAI | 4.035 | 1297/901/0 | stop | $0.001675750 |
| Black Myth: Wukong | online | 成功 | google/gemini-3.1-flash-lite / OpenAI | 3.929 | 1297/835/0 | stop | $0.001576750 |

可归属总花费：`$0.008240000`（5/5 个调用有花费元数据）。
...
- `overwatch-2` / `online`：default_pc_keybinds['技能1'] 不是单一规范化 PC 输入：'Shift'
...
- 开始：`2026-09-01T04:15:28.723781+00:00`
- 结束：`2026-09-01T04:15:49.660224+00:00`
