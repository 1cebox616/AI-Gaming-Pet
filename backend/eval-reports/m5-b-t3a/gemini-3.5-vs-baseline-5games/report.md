# M5-B-T3a Google Gemini 3.5 Flash Lite challenger 游戏知识探针报告

本轮只验证修改后的详细游戏 context 提示词，不替换上一轮正式 3 模型 × 15 游戏判卷，也不作选型推荐。

## 模型与样本

- 模型：[Google Gemini 3.5 Flash Lite challenger](https://openrouter.ai/google/gemini-3.5-flash-lite-20260721)（`google/gemini-3.5-flash-lite`）。
...
|---|---:|---:|---:|---:|---:|---:|
| 联网模式 | 5/5 | 3/5 | 3/5 | 6.710 / 7.460 / 7.790 | 5/5 | $0.058961200 |

## 逐次结果

| 游戏 | 模式 | 状态 | 实际模型／上游 | 耗时（秒） | 输入／输出／推理 token | finish_reason | 花费（USD） |
|---|---|---|---|---:|---:|---|---:|
| Cyberpunk 2077 | online | 格式不合 | google/gemini-3.5-flash-lite / OpenAI | 7.790 | 7145/1135/0 | stop | $0.011981000 |
| Counter-Strike 2 | online | 成功 | google/gemini-3.5-flash-lite / OpenAI | 6.503 | 6470/1378/0 | stop | $0.012386000 |
| Stardew Valley | online | 格式不合 | google/gemini-3.5-flash-lite / OpenAI | 6.560 | 5348/1232/0 | stop | $0.011684400 |
| Hearthstone | online | 成功 | google/gemini-3.5-flash-lite / OpenAI | 6.710 | 5758/958/0 | stop | $0.011122400 |
| Terraria | online | 成功 | google/gemini-3.5-flash-lite / OpenAI | 6.964 | 5683/1233/0 | stop | $0.011787400 |

可归属总花费：`$0.058961200`（5/5 个调用有花费元数据）。
...
- `cyberpunk-2077` / `online`：default_pc_keybinds['瞄准'] 不是单一规范化 PC 输入：'RightLeft'
- `stardew-valley` / `online`：default_pc_keybinds['快捷物品栏12'] 不是单一规范化 PC 输入：'Plus'
...
- 开始：`2026-09-01T13:37:54.228067+00:00`
- 结束：`2026-09-01T13:38:28.795938+00:00`
