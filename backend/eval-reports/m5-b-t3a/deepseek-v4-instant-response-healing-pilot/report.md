...
- 模型：[DeepSeek V4 Flash 0731 (Instant, response-healing)](https://openrouter.ai/deepseek/deepseek-v4-flash-0731)（`deepseek/deepseek-v4-flash-0731`）。
...
|---|---:|---:|---:|---:|---:|---:|
| 联网模式 | 3/3 | 1/3 | 1/3 | 31.102 / 34.853 / 35.791 | 0/3 | $0.028675100 |

## 逐次结果

| 游戏 | 模式 | 状态 | 实际模型／上游 | 耗时（秒） | 输入／输出／推理 token | finish_reason | 花费（USD） |
|---|---|---|---|---:|---:|---|---:|
| Marvel Rivals | online | 格式不合 | deepseek/deepseek-v4-flash-0731 / OpenAI | 35.791 | 10077/2791/0 | stop | $0.009713150 |
| EA Sports FC 26 | online | 成功 | deepseek/deepseek-v4-flash-0731 / OpenAI | 27.959 | 10361/1790/0 | stop | $0.009327700 |
| Hades II | online | 格式不合 | deepseek/deepseek-v4-flash-0731 / OpenAI | 31.102 | 11795/1869/0 | stop | $0.009634250 |

可归属总花费：`$0.028675100`（3/3 个调用有花费元数据）。
...
- `marvel-rivals` / `online`：顶层字段不匹配：缺少 ['background', 'default_pc_keybinds', 'game_overview', 'gameplay']；多出 []
- `hades-ii` / `online`：响应中存在多个符合合同的 JSON 对象，无法确定唯一结果
...
- 开始：`2026-09-01T04:07:44.796207+00:00`
- 结束：`2026-09-01T04:09:19.690931+00:00`
