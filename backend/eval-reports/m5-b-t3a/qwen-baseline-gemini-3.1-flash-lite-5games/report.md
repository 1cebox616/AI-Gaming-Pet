# M5-B-T3a Google Gemini 3.1 Flash Lite baseline 游戏知识探针报告

本轮只验证修改后的详细游戏 context 提示词，不替换上一轮正式 3 模型 × 15 游戏判卷，也不作选型推荐。

## 模型与样本

- 模型：[Google Gemini 3.1 Flash Lite baseline](https://openrouter.ai/google/gemini-3.1-flash-lite)（`google/gemini-3.1-flash-lite`）。
...
|---|---:|---:|---:|---:|---:|---:|
| 联网模式 | 5/5 | 5/5 | 4/5 | 4.031 / 4.831 / 5.133 | 5/5 | $0.008559500 |

## 逐次结果

| 游戏 | 模式 | 状态 | 实际模型／上游 | 耗时（秒） | 输入／输出／推理 token | finish_reason | 花费（USD） |
|---|---|---|---|---:|---:|---|---:|
| Cyberpunk 2077 | online | 成功 | google/gemini-3.1-flash-lite / OpenAI | 5.133 | 1298/889/0 | stop | $0.001658000 |
| Counter-Strike 2 | online | 成功 | google/gemini-3.1-flash-lite / OpenAI | 3.821 | 1296/911/0 | stop | $0.001690500 |
| Stardew Valley | online | 已规范化／原样不合 | google/gemini-3.1-flash-lite / OpenAI | 4.031 | 1295/973/0 | stop | $0.001783250 |
| Hearthstone | online | 成功 | google/gemini-3.1-flash-lite / OpenAI | 3.905 | 1294/870/0 | stop | $0.001628500 |
| Terraria | online | 成功 | google/gemini-3.1-flash-lite / OpenAI | 4.378 | 1293/984/0 | stop | $0.001799250 |

可归属总花费：`$0.008559500`（5/5 个调用有花费元数据）。
...
- `stardew-valley` / `online`：键位输入 '-' → 'Minus'（动作：快捷物品栏11）；键位输入 '=' → 'Equals'（动作：快捷物品栏12）
...
- 开始：`2026-09-01T13:16:53.724472+00:00`
- 结束：`2026-09-01T13:17:15.032142+00:00`
