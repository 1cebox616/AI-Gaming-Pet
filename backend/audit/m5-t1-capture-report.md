...
修正后的 Project Zomboid 样本 14 中，连续 41 次无新帧期间探针仍保持每 2 秒轮询，
单次抓帧最大 38.172ms，确认应用层无限等待已修复。样本 15 又把 WGC 光标合成从
...
Grey Zone Warfare、Disco Elysium 与 Subnautica 2 共 11 次正式会话；另有 4 次
Project Zomboid 会话只用于兼容性诊断。正式上下文、指标与逐帧人工复核记录在
